...
/**
 * This class represents a directory in the file system. It contains a collection of children referencing files and
 * other directories.
 */
class Directory extends FileSystemObject {
   ...
   *
   * Currently, it does not include files and directories starting with a dot, e.g. .svn. This filtering cannot be
   * customized before the arrival of PHP 5.4.
   *
  ...
  public function expand(\Closure $filter) {
    ...
    $fileSystemIterator = new \RecursiveIteratorIterator($directoryIterator, \RecursiveIteratorIterator::SELF_FIRST);

    $filterIterator = new \CallbackFilterIterator($fileSystemIterator, $filter);
  ...
  /**
   * This method returns the absolute path to a given relative one. When calling this method for a directory, then the
   * resulting absolute path will always have a trailing slash.
   *
